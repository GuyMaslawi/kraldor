        ...
        <div className="min-w-0 flex-1 space-y-4">
          <div className="space-y-10 pt-2">
            ...
            <GuideSection meta={sections.worldboss} index={INDEX.worldboss}>
              ...
              <Note tone="purple" icon="turns" title={t("שבוע אחד, מפלצת אחת")}>{t("איזו מפלצת מופיעה נגזר מהשבוע עצמו, כך שכל שחקן בעולם רואה את אותה מפלצת בלי שאף אחד ״פתח״ אותה. מה שלא הופל עד סוף השבוע פשוט נעלם, והשבוע הבא מביא חדשה — עם מאגר חיים חדש ומכסת מכות חדשה.")}</Note>
            </GuideSection>
            ...
            <GuideSection meta={sections.chat} index={INDEX.chat}>
              ...
              <Note tone="purple" icon="messages" title={t("צ׳אט מול תיבת הדואר")}>{t("שני ערוצים שונים בכוונה. הצ׳אט הוא שיחה חיה וקצרה שנקראת עכשיו; תיבת ההודעות בסרגל העליון היא הארכיון — דוחות קרב, ריגול, שלל של שליטי ערים והודעות ארוכות, שממתינות שם עד שתקרא אותן. הודעה פרטית בצ׳אט מדליקה מונה על הלשונית, לא בתיבה.")}</Note>
